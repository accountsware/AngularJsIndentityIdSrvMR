...
namespace BrockAllen.MembershipReboot
{
        ...
        
    {
        ...
        private IEnumerable<Claim> GetPendingAuthClaims(UserAccount account)
        {
            if (account == null) throw new ArgumentNullException("account");
            ...
            out UserAccount account)
        {
            ...
            else
            {
                ...
                if (account == null)
                {
                    ...
                    var cmd = new MapClaimsToAccount<UserAccount> { Account = account, Claims = claims };
        ...
        {
            IEnumerable<char> validChars = name.Where(UserAccountValidation<UserAccount>.IsValidUsernameChar);

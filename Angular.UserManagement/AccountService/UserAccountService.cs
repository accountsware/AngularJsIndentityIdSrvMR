...
namespace BrockAllen.MembershipReboot
{
        ...
        
    {
        ...
        Lazy<AggregateValidator<UserAccount>> usernameValidator;
        Lazy<AggregateValidator<UserAccount>> emailValidator;
        ...
        public UserAccountService(MembershipRebootConfiguration configuration, IUserAccountRepository userRepository)
        {
            ...
            validationEventBus.Add(new UserAccountValidator<UserAccount>(this));
            this.userRepository = new EventBusUserAccountRepository(this, userRepository,
                new AggregateEventBus { validationEventBus, configuration.ValidationBus },
                configuration.EventBus);

            this.usernameValidator = new Lazy<AggregateValidator<UserAccount>>(() =>
            {
                var val = new AggregateValidator<UserAccount>();
                if (!this.Configuration.EmailIsUsername)
                {
                    val.Add(UserAccountValidation<UserAccount>.UsernameDoesNotContainAtSign);
                    val.Add(UserAccountValidation<UserAccount>.UsernameCanOnlyStartOrEndWithLetterOrDigit);
                    val.Add(UserAccountValidation<UserAccount>.UsernameOnlyContainsValidCharacters);
                    val.Add(UserAccountValidation<UserAccount>.UsernameOnlySingleInstanceOfSpecialCharacters);
                }
                val.Add(UserAccountValidation<UserAccount>.UsernameMustNotAlreadyExist);
                val.Add(configuration.UsernameValidator);
                return val;
            });

            this.emailValidator = new Lazy<AggregateValidator<UserAccount>>(() =>
            {
                var val = new AggregateValidator<UserAccount>();
                val.Add(UserAccountValidation<UserAccount>.EmailIsRequiredIfRequireAccountVerificationEnabled);
                val.Add(UserAccountValidation<UserAccount>.EmailIsValidFormat);
                if (configuration.EmailIsUnique)
                {
                    val.Add(UserAccountValidation<UserAccount>.EmailMustNotAlreadyExist);
                }
                val.Add(configuration.EmailValidator);
                return val;
            });

            this.passwordValidator = new Lazy<AggregateValidator<UserAccount>>(() =>
            {
                var val = new AggregateValidator<UserAccount>();
                val.Add(UserAccountValidation<UserAccount>.PasswordMustBeDifferentThanCurrent);
        ...
        public virtual IUserAccountQuery<UserAccount> Query 
        {
            get
            {
                return this.userRepository.inner as IUserAccountQuery<UserAccount>;
            } 
        }
        ...
        protected internal bool EmailExistsOtherThan(UserAccount account, string email)
        {
        ...
        protected void Init(UserAccount account, string tenant, string username, string password, string email, Guid? id = null, DateTime? dateCreated = null)
        {
            ...
            this.AddEvent(new AccountCreatedEvent<UserAccount> { Account = account, InitialPassword = password, VerificationKey = key });
        }
        ...
        protected virtual void CloseAccount(UserAccount account)
        {
            ...
            if (!account.IsAccountClosed)
            {
                ...
                this.AddEvent(new AccountClosedEvent<UserAccount> { Account = account });
            }
            else
            {
        ...
        public virtual void ReopenAccount(UserAccount account)
        {
            ...
            ClearVerificationKey(account);
            var key = SetVerificationKey(account, VerificationKeyPurpose.ChangeEmail, state: account.Email);
            this.AddEvent(new AccountReopenedEvent<UserAccount> { Account = account, VerificationKey = key });
        ...
        public virtual bool Authenticate(string username, string password, out UserAccount account, out AuthenticationFailureCode failureCode)
        {
        ...
        public virtual bool Authenticate(string tenant, string username, string password, out UserAccount account, out AuthenticationFailureCode failureCode)
        {
            account = null;
        ...
        public virtual bool AuthenticateWithEmail(string email, string password, out UserAccount account, out AuthenticationFailureCode failureCode)
        {
        ...
        public virtual bool AuthenticateWithEmail(string tenant, string email, string password, out UserAccount account, out AuthenticationFailureCode failureCode)
        {
            account = null;
        ...
        public virtual bool AuthenticateWithUsernameOrEmail(string userNameOrEmail, string password, out UserAccount account, out AuthenticationFailureCode failureCode)
        {
        ...
        public virtual bool AuthenticateWithUsernameOrEmail(string tenant, string userNameOrEmail, string password, out UserAccount account, out AuthenticationFailureCode failureCode)
        {
            account = null;
        ...
        protected virtual bool Authenticate(UserAccount account, string password, out AuthenticationFailureCode failureCode)
        {
        ...
        protected virtual bool VerifyPassword(UserAccount account, string password, out AuthenticationFailureCode failureCode)
        {
        ...
        public virtual bool AuthenticateWithCode(Guid accountID, string code, out UserAccount account)
        {
            ...
            this.AddEvent(new SuccessfulTwoFactorAuthCodeLoginEvent<UserAccount> { Account = account });
        ...
        protected virtual bool Authenticate(UserAccount account, X509Certificate2 certificate)
        {
            ...
            if (!(certificate.NotBefore < UtcNow && UtcNow < certificate.NotAfter))
            {
                ...
                this.AddEvent(new InvalidCertificateEvent<UserAccount> { Account = account, Certificate = certificate });
                return false;
            }
            ...
            this.AddEvent(new SuccessfulCertificateLoginEvent<UserAccount> { Account = account, UserCertificate = match, Certificate = certificate });
        ...
        public virtual void AddPasswordResetSecret(Guid accountID, string question, string answer)
        {
            ...
            this.AddEvent(new PasswordResetSecretAddedEvent<UserAccount> { Account = account, Secret = secret });
        ...
        public virtual void RemovePasswordResetSecret(Guid accountID, Guid questionID)
        {
            ...
            if (item != null)
            {
                ...
                this.AddEvent(new PasswordResetSecretRemovedEvent<UserAccount> { Account = account, Secret = item });
                Update(account);
            }
            else
            {
        ...
        public virtual void ResetPasswordFromSecretQuestionAndAnswer(Guid accountID, PasswordResetQuestionAnswer[] answers)
        {
                ...
                account.LastFailedPasswordReset >= UtcNow.Subtract(Configuration.AccountLockoutDuration))
            {
                ...
                this.AddEvent(new PasswordResetFailedEvent<UserAccount> { Account = account });
        ...
        public virtual void SendUsernameReminder(string tenant, string email)
        {
            ...
            this.AddEvent(new UsernameReminderRequestedEvent<UserAccount> { Account = account });
        ...
        public virtual void ChangeUsername(Guid accountID, string newUsername)
        {
            ...
            this.AddEvent(new UsernameChangedEvent<UserAccount> { Account = account });
        ...
        public virtual void ChangeEmailRequest(Guid accountID, string newEmail)
        {
            ...
            if (!Configuration.RequireAccountVerification)
            {
                ...
                this.AddEvent(new EmailChangedEvent<UserAccount> { Account = account, OldEmail = oldEmail, VerificationKey = key });
                Update(account);
            }
            else
            {
                Tracing.Verbose("[UserAccountService.ChangeEmailRequest] RequireAccountVerification true, sending changing email");
                this.AddEvent(new EmailChangeRequestedEvent<UserAccount> { Account = account, OldEmail = oldEmail, NewEmail = newEmail, VerificationKey = key });
                UpdateInternal(account);
            }
        ...
        public virtual void VerifyEmailFromKey(string key, string password, out UserAccount account)
        {
            ...
            this.AddEvent(new EmailVerifiedEvent<UserAccount> { Account = account });
        ...
        public virtual void RemoveMobilePhone(Guid accountID)
        {
            ...
            this.AddEvent(new MobilePhoneRemovedEvent<UserAccount> { Account = account });
        ...
        public virtual void ChangeMobilePhoneRequest(Guid accountID, string newMobilePhoneNumber)
        {
                ...
                account.CurrentTwoFactorAuthStatus == TwoFactorAuthMode.Mobile)
            {
                ...
                this.AddEvent(new MobilePhoneChangeRequestedEvent<UserAccount> { Account = account, NewMobilePhoneNumber = newMobilePhoneNumber, Code = code });
            }
            else
            {
        ...
        public virtual bool ChangeMobilePhoneFromCode(Guid accountID, string code)
        {
            ...
            this.AddEvent(new MobilePhoneChangedEvent<UserAccount> { Account = account });
        ...
        private void AddClaim(UserAccount account, UserClaim claim)
        {
            ...
            if (!account.HasClaim(claim.Type, claim.Value))
            {
                ...
                this.AddEvent(new ClaimAddedEvent<UserAccount> {Account = account, Claim = claim});
        ...
        public virtual void RemoveClaim(Guid accountID, string type)
        {
            ...
            foreach (var claim in claimsToRemove.ToArray())
            {
                ...
                this.AddEvent(new ClaimRemovedEvent<UserAccount> { Account = account, Claim = claim });
        ...
        public virtual void AddOrUpdateLinkedAccount(UserAccount account, string provider, string id, IEnumerable<Claim> claims = null)
        {
            ...
            if (linked == null)
            {
                ...
                this.AddEvent(new LinkedAccountAddedEvent<UserAccount> { Account = account, LinkedAccount = linked });
        ...
        public virtual void RemoveLinkedAccount(Guid accountID, string provider, string id)
        {
            ...
            if (linked != null)
            {
                ...
                this.AddEvent(new LinkedAccountRemovedEvent<UserAccount> { Account = account, LinkedAccount = linked });
        ...
        protected virtual void RemoveLinkedAccountClaims(UserAccount account, string provider, string id)
        {
            if (account == null) throw new ArgumentNullException("account");
        ...
        protected virtual void AddCertificate(UserAccount account, string thumbprint, string subject)
        {
            ...
            this.AddEvent(new CertificateAddedEvent<UserAccount> { Account = account, Certificate = cert });
        }
        ...
        protected virtual void RemoveCertificate(UserAccount account, string thumbprint)
        {
            ...
            {
                this.AddEvent(new CertificateRemovedEvent<UserAccount> { Account = account, Certificate = cert });
        ...
        protected virtual void CreateTwoFactorAuthToken(UserAccount account)
        {
            ...
            if (cmd.Success)
            {
                ...
                this.AddEvent(new TwoFactorAuthenticationTokenCreatedEvent<UserAccount> { Account = account, Token = value });
        ...
        public virtual IEnumerable<Claim> MapClaims(UserAccount account)
        {
            ...
            var cmd = new MapClaimsFromAccount<UserAccount> { Account = account };
            ExecuteCommand(cmd);

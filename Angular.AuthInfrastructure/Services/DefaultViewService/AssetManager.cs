...
namespace Angular.AuthInfrastructure.Services.DefaultViewService
{
    internal class AssetManager
    {
        public const string HttpAssetsNamespace = "Angular.AuthInfrastructure.Services.DefaultViewService.HttpAssets";
        public const string FontAssetsNamespace = HttpAssetsNamespace + ".libs.bootstrap.fonts";

        public const string PageAssetsNamespace = "Angular.AuthInfrastructure.Services.DefaultViewService.PageAssets";

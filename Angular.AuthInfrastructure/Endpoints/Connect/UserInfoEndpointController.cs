...
using Angular.AuthInfrastructure.Configuration.Hosting;
using Angular.AuthInfrastructure.Events.Base;
using Angular.AuthInfrastructure.Extensions;
using Angular.AuthInfrastructure.ResponseHandling;
using Angular.AuthInfrastructure.Results;
using Angular.AuthInfrastructure.Services;
using Angular.AuthInfrastructure.Validation;

#pragma warning disable 1591

namespace Angular.AuthInfrastructure.Endpoints.Connect
{
    /// <summary>

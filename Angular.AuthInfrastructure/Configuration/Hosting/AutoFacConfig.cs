...
using Angular.AuthInfrastructure.Endpoints.Connect;
using Angular.AuthInfrastructure.Models;
using Angular.AuthInfrastructure.ResponseHandling;
using Angular.AuthInfrastructure.Services;
using Angular.AuthInfrastructure.Services.Default;
using Angular.AuthInfrastructure.Services.DefaultViewService;
using Angular.AuthInfrastructure.Services.ExternalClaimsFilter;
using Angular.AuthInfrastructure.Services.InMemory;
using Angular.AuthInfrastructure.Validation;
using Autofac;
